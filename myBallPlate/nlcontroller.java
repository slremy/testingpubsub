...
public class nlcontroller extends TimerTask{
    ...
    public int uprocess(String server_ip, int port, String control_action)
    {
        ...
        int datalen=0;
        try {
            //come back to this, I'll need to complete ther 
            String urlupdate = "http://"+server_ip+":"+Integer.toString(port)+control_action;
            URL oracle = new URL(urlupdate);
    ...
    public void controlState(){
        ...
        url=String.format("/u?&value0=%.4f&value1=%.4f&t=%.6f&]",u_x,u_y,t1);
    ...
    public nlcontroller(String args[]){
        ...
        String myfilename;
        myfilename=String.format("jurl%s_%s_%s.txt",clientname, network, suffix);
        System.out.format( "\nLogging data to %s\n", myfilename);
        try {
    ...
    public static void main(String args[]) throws Exception{
        ...
        if (args.length > 4)
        {
            nlcontroller controller = new nlcontroller(args);
