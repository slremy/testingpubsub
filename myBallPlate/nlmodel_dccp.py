...
if __name__ == "__main__":
    ...
    #create the DCCP socket server (create the socket, and then listen until you can't)
    server = None
    try:
        server = socket.socket(socket.AF_INET, socket.SOCK_DCCP, socket.IPPROTO_DCCP)   #DCCP
